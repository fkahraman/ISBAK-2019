...
if __name__ == '__main__':
    ...
    x = arange(0, 2120, 1)
    y = array(DATASensor[0:2120])

    x_fark = arange(0, 2120, 1)
    y_fark = array(DATAFark[0:2120])

    x_min = arange(0, 2120, 1)
    y_min = array(DATAMin[0:2120])

    x_max = arange(0, 2120, 1)
    y_max = array(DATAMax[0:2120])

    #x_tplm = arange(0, 2120, 1)
    #y_tplm = array(DATAToplam[0:2120])
    ...
    #plot(x_tplm, y_tplm, "-o",label='Ara Toplam Grafiği')
