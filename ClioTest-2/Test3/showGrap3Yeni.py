...
if __name__ == '__main__':
    ...
    x = arange(0, 1712, 1)
    y = array(DATASensor[0:1712])

    x_fark = arange(0, 1712, 1)
    y_fark = array(DATAFark[0:1712])

    x_min = arange(0, 1712, 1)
    y_min = array(DATAMin[0:1712])

    x_max = arange(0, 1712, 1)
    y_max = array(DATAMax[0:1712])
