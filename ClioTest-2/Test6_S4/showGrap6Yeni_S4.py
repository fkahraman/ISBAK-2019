...
if __name__ == '__main__':
    ...
    x = arange(0, 719, 1)
    y = array(DATASensor[0:719])

    x_fark = arange(0, 719, 1)
    y_fark = array(DATAFark[0:719])

    x_min = arange(0, 719, 1)
    y_min = array(DATAMin[0:719])

    x_max = arange(0, 719, 1)
    y_max = array(DATAMax[0:719])
