...
if __name__ == '__main__':
    ...
    df = pd.read_excel('Büyük araç test grafikleri py.xlsx', sheet_name='TEST1', header=None)

    #aracDurum = df[8]   # Şahsi değerler
    sensorToplam = df[6]    # 3 eksen toplam değerler

    sensorToplam = sensorToplam[2:2150]
    ...
    sensorToplam = sensorToplam[15:2130]
    ...
    Location = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\BuyukAracTest\Test1\SensorValue.txt'
    ...
    Location2 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\BuyukAracTest\Test1\EMAValue.txt'
    ...
    Location3 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\BuyukAracTest\Test1\SMAValue.txt'
    ...
    Location4 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\BuyukAracTest\Test1\SapmaValue.txt'
    ...
    Location5 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\BuyukAracTest\Test1\SapmaSMAValue.txt'
