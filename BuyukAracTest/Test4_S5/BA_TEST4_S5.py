...
if __name__ == '__main__':
    ...
    df = pd.read_excel('Büyük araç test grafikleri py.xlsx', sheet_name='TEST4', header=None)

    #aracDurum = df[8]   # Şahsi değerler
    sensorToplam = df[12]    # 3 eksen toplam değerler

    sensorToplam = sensorToplam[2:413]
    ...
    sensorToplam = sensorToplam[15:395]
    ...
    Location = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\BuyukAracTest\Test4_S5\SensorValue.txt'
    ...
    Location2 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\BuyukAracTest\Test4_S5\EMAValue.txt'
    ...
    Location3 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\BuyukAracTest\Test4_S5\SMAValue.txt'
    ...
    Location4 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\BuyukAracTest\Test4_S5\SapmaValue.txt'
    ...
    Location5 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\BuyukAracTest\Test4_S5\SapmaSMAValue.txt'
