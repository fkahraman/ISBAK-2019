...
if __name__ == '__main__':
    ...
    x = arange(0, 405, 1)
    y = array(DATASensor[0:405])

    #xS = arange(0, 805, 1)
    #yS = array(DATAEMA[0:805])

    x_sma = arange(0, 405, 1)
    y_sma = array(DATASMA[0:405])

    x_sapma = arange(0,405,1)
    y_sapma = array(DATASapma[0:405])

    x_sapmaSMA = arange (0,405,1)
    y_sapmaSMA = array(DATASapmaSMA[0:405])
