...
if __name__ == '__main__':
    ...
    df = pd.read_excel('Clio test grafikleriPy.xlsx', sheet_name='TEST3', header=None)

    #aracDurum = df[8]   # Şahsi değerler
    sensorToplam = df[7]    # 3 eksen toplam değerler

    sensorToplam = sensorToplam[2:1714]
    ...
    sensorToplam = sensorToplam[15:1695]
    ...
    Location = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test3\SensorValue.txt'
    ...
    Location2 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test3\EMAValue.txt'
    ...
    Location3 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test3\SMAValue.txt'
    ...
    Location4 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test3\SapmaValue.txt'
    ...
    Location5 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test3\SapmaSMAValue.txt'
