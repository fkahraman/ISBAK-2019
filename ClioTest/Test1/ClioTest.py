...
if __name__ == '__main__':
    ...
    df = pd.read_excel('Clio test grafikleriPy.xlsx', sheet_name='TEST1', header=None)

    #aracDurum = df[8]   # Şahsi değerler
    sensorToplam = df[7]    # 3 eksen toplam değerler

    sensorToplam = sensorToplam[2:2122]
    ...
    sensorToplam = sensorToplam[15:2115]
    ...
    Location2 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test1\EMAValue.txt'
    ...
    Location3 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test1\SMAValue.txt'
    ...
    Location4 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test1\SapmaValue.txt'
    ...
    Location5 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test1\SapmaSMAValue.txt'
