...
if __name__ == '__main__':
    ...
    x = arange(0, 2080, 1)
    y = array(DATASensor[0:2080])

    #xS = arange(0, 2000, 1)
    #yS = array(DATAEMA[0:2000])

    x_sma = arange(0, 2080, 1)
    y_sma = array(DATASMA[0:2080])

    x_sapma = arange(0,2080,1)
    y_sapma = array(DATASapma[0:2080])

    x_sapmaSMA = arange (0,2080,1)
    y_sapmaSMA = array(DATASapmaSMA[0:2080])
