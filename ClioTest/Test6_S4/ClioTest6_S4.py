...
if __name__ == '__main__':
    ...
    df = pd.read_excel('Clio test grafikleriPy.xlsx', sheet_name='TEST6', header=None)

    #aracDurum = df[8]   # Şahsi değerler
    sensorToplam = df[7]    # 3 eksen toplam değerler

    sensorToplam = sensorToplam[2:721]
    ...
    sensorToplam = sensorToplam[15:700]
    ...
    Location = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test6_S4\SensorValue.txt'
    ...
    Location2 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test6_S4\EMAValue.txt'
    ...
    Location3 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test6_S4\SMAValue.txt'
    ...
    Location4 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test6_S4\SapmaValue.txt'
    ...
    Location5 = r'C:\Users\fatih\PycharmProjects\untitled\AFTER ISBAK 2019\ClioTest\Test6_S4\SapmaSMAValue.txt'
