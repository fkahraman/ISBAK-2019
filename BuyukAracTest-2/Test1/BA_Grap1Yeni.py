...
if __name__ == '__main__':
    ...
    x = arange(0, 2148, 1)
    y = array(DATASensor[0:2148])

    x_fark = arange(0, 2148, 1)
    y_fark = array(DATAFark[0:2148])

    x_min = arange(0, 2148, 1)
    y_min = array(DATAMin[0:2148])

    x_max = arange(0, 2148, 1)
    y_max = array(DATAMax[0:2148])
